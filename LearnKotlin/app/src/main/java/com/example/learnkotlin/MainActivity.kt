...
private fun AffirmationCardPreview(){
    AffirmationCard(Affirmation(R.string.app_name, R.drawable.image1))
}
...
//    buildAquarium()
    val objSpeed = Hello();
    objSpeed.feedTheFish();
//    objSpeed.swim("slow")
//    objSpeed.swim(speed = "turtle-like")


}

fun buildAquarium() {
    val myAquanews = Aquanews()
    myAquanews.printSize()
}